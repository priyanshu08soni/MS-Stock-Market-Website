...
const Dashboard = () => {
  ...
  // console.log(historicalData[stockSymbol]);
  // useEffect(()=>{
  ...
  useEffect(()=>{
    ...
    setStockData(data);
    console.log(stockData,currentDate.getDate(),currentDate.getMonth()+1,currentDate.getFullYear(),endDate.getDate(),endDate.getMonth()+1,endDate.getFullYear());
    ...
    <>
      ...
      >
        ...
        <div className='flex justify-end gap-4'>
            ...
            <input type="date" value={toDate} onChange={e=>setToDate(e.target.value)} min="2020-05-05" max="2021-04-30"  className='my-2 py-1 px-4 rounded-md bg-blue-950 border-2 border-gray-600' />
        </div>
