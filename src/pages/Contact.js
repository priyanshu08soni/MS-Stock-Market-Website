          ...
          <div className="flex flex-wrap flex-col contact">
            <div className="contact-cards ms-4 px-1 font-extrabold text-sm text-gray-800">
              <div className="contact-text">
                ...
                here to support you in your investment journey and answer any
                questions you may have. Whether you need help navigating our
                site, understanding the data, or have inquiries about our
                services, our team is ready to assist. 
                </p>
                <p className="text-gray-600 pt-5 pb-1 ">Expert Guidance:</p>
                Have questions about our interactive charts,
                graphs, or tables? Our experts can guide you on how to
                effectively use these tools to analyze market trends and make
                informed investment decisions.
                <p className="text-gray-600 pt-5 pb-1 ">Feedback:</p>
                We value your feedback and are constantly
                striving to improve our platform. If you have suggestions on how
                we can enhance your experience, please don’t hesitate to share.
              </div>
