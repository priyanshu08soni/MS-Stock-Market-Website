  ...
  return (
    <div className={`min-h-screen transition-colors duration-300 ${darkMode ? "bg-slate-900 text-gray-100" : "bg-gray-100 text-gray-800"}`}>
      ...
      <main className="max-w-7xl mx-auto px-6 py-12">
        <h1 className="text-4xl md:text-5xl font-bold mb-12 bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 to-purple-500">
          #Contact
        </h1>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          <div className={`p-8 rounded-3xl shadow-md backdrop-blur-sm ${darkMode ? "bg-slate-800/50" : "bg-white"}`}>
            <p className="text-lg leading-relaxed mb-6 opacity-90">
              Thank you for visiting our stock market analysis platform! We’re
              here to support you in your investment journey.
            </p>

            <div className="space-y-6">
              <div>
                <h3 className="text-xl font-bold text-indigo-500 mb-2">Expert Guidance</h3>
                <p className="opacity-80">
                  Have questions about our interactive charts or tools? Our team is ready to help you analyze market trends effectively.
                </p>
              </div>

              <div>
                <h3 className="text-xl font-bold text-indigo-500 mb-2">Feedback</h3>
                <p className="opacity-80">
                  We value your feedback. If you have suggestions on how we can improve, please don't hesitate to share.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mt-12 mb-8 grid grid-cols-1 md:grid-cols-3 gap-6">
          <a href="mailto:priyanshus20k4@gmail.com" className={`flex items-center gap-4 p-4 rounded-2xl border transition hover:-translate-y-1 ${darkMode ? "bg-neutral-900/40 border-neutral-800 hover:border-indigo-500" : "bg-white/60 border-white shadow-sm hover:border-indigo-300"}`}>
            <div className="p-3 bg-red-500/10 rounded-xl text-red-500"><IoIosMail size={24} /></div>
            <span className={`font-medium ${darkMode ? "text-gray-200" : "text-gray-700"}`}>Gmail</span>
          </a>
          <a href="https://priyanshus20k4.wixstudio.io/my-portfolio" className={`flex items-center gap-4 p-4 rounded-2xl border transition hover:-translate-y-1 ${darkMode ? "bg-neutral-900/40 border-neutral-800 hover:border-indigo-500" : "bg-white/60 border-white shadow-sm hover:border-indigo-300"}`}>
            <div className="p-3 bg-blue-500/10 rounded-xl text-blue-500"><SiWebmoney size={24} /></div>
            <span className={`font-medium ${darkMode ? "text-gray-200" : "text-gray-700"}`}>Portfolio</span>
          </a>
          <a href="https://github.com/priyanshu08soni/" className={`flex items-center gap-4 p-4 rounded-2xl border transition hover:-translate-y-1 ${darkMode ? "bg-neutral-900/40 border-neutral-800 hover:border-indigo-500" : "bg-white/60 border-white shadow-sm hover:border-indigo-300"}`}>
            <div className={`p-3 rounded-xl ${darkMode ? "bg-white/10 text-white" : "bg-black/5 text-black"}`}><VscGithub size={24} /></div>
